...
::: callout-note
Code and referencing computed values using inline quarto results -- you need to use quarto inline references and if necessary generate a results table. Also, spellcheck.
:::
